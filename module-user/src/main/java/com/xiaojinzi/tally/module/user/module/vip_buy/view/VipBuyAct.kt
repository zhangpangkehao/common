...
import com.xiaojinzi.tally.module.base.support.interceptor.NotLoginRouterInterceptor
...
@RouterAnno(
    hostAndPath = AppRouterConfig.USER_VIP_BUY,
    interceptors = [
        OpenSourceNotSupportRouterInterceptor::class,
        NotLoginRouterInterceptor::class,
    ],
)
@ViewLayer
class VipBuyAct : BaseBusinessAct<VipBuyViewModel>() {

    override fun getViewModelClass(): Class<VipBuyViewModel> {
        return VipBuyViewModel::class.java
    }
