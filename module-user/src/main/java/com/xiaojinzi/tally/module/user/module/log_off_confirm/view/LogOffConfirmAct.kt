...
@RouterAnno(
    hostAndPath = AppRouterConfig.USER_LOG_OFF_CONFIRM,
    interceptors = [
        AlphaInAnimInterceptor::class,
    ],
)
@ViewLayer
class LogOffConfirmAct : BaseBusinessAct<LogOffConfirmViewModel>() {

    override fun getViewModelClass(): Class<LogOffConfirmViewModel> {
        return LogOffConfirmViewModel::class.java
    }
