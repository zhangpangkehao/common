...
@RouterAnno(
    hostAndPath = AppRouterConfig.MAIN_THEME_SELECT,
)
@ViewLayer
class ThemeSelectAct : BaseBusinessAct<ThemeSelectViewModel>() {

    override fun getViewModelClass(): Class<ThemeSelectViewModel> {
        return ThemeSelectViewModel::class.java
    }
