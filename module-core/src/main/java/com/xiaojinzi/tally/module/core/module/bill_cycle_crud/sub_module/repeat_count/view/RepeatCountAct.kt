...
@RouterAnno(
    hostAndPath = AppRouterConfig.CORE_BILL_CYCLE_REPEAT_COUNT,
)
@ViewLayer
class RepeatCountAct : BaseBusinessAct<RepeatCountViewModel>() {

    override fun getViewModelClass(): Class<RepeatCountViewModel> {
        return RepeatCountViewModel::class.java
    }
