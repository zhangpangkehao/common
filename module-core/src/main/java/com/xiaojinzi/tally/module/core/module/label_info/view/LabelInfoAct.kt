...
@RouterAnno(
    hostAndPath = AppRouterConfig.CORE_LABEL_INFO,
)
@ViewLayer
class LabelInfoAct : BaseBusinessAct<LabelInfoViewModel>() {

    override fun getViewModelClass(): Class<LabelInfoViewModel> {
        return LabelInfoViewModel::class.java
    }
