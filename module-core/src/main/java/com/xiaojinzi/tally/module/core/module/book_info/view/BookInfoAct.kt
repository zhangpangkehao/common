...
@RouterAnno(
    hostAndPath = AppRouterConfig.CORE_BOOK_INFO,
)
@ViewLayer
class BookInfoAct : BaseBusinessAct<BookInfoViewModel>() {

    override fun getViewModelClass(): Class<BookInfoViewModel> {
        return BookInfoViewModel::class.java
    }
