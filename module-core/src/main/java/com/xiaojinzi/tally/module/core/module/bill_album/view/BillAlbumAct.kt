...
@RouterAnno(
    hostAndPath = AppRouterConfig.CORE_BILL_ALBUM,
)
@ViewLayer
class BillAlbumAct : BaseBusinessAct<BillAlbumViewModel>() {

    override fun getViewModelClass(): Class<BillAlbumViewModel> {
        return BillAlbumViewModel::class.java
    }
