...
@RouterAnno(
    hostAndPath = AppRouterConfig.CORE_SYNC_LOG,
)
@ViewLayer
class SyncLogAct : BaseBusinessAct<SyncLogViewModel>() {

    override fun getViewModelClass(): Class<SyncLogViewModel> {
        return SyncLogViewModel::class.java
    }
